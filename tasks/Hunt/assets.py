...
class HuntAssets: 
	...
	# 点击挑战 
	I_NW_CHALLAGE = RuleImage(roi_front=(306,590,171,63), roi_back=(306,590,171,63), threshold=0.77, method="Template matching", file="./tasks/Hunt/netherworld/netherworld_nw_challage.png")
	# 今日已挑战 
